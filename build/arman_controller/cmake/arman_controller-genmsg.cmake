...
get_filename_component(_filename "/home/m_dyse/Arman/src/arman_controller/srv/ArmanDriverRequest.srv" NAME_WE)
add_custom_target(_arman_controller_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "arman_controller" "/home/m_dyse/Arman/src/arman_controller/srv/ArmanDriverRequest.srv" ""
)
...
_generate_srv_cpp(arman_controller
  "/home/m_dyse/Arman/src/arman_controller/srv/ArmanDriverRequest.srv"
  "${MSG_I_FLAGS}"
  ""
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/arman_controller)
  install(CODE "execute_process(COMMAND \"/usr/bin/python2\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/arman_controller\")")
  # install generated code
  install(
